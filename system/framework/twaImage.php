...
class twaImage extends twaFile {
	...
	public function __construct($filepath=null) {
        ...
        $this->fileformat['jpg'] = "jpeg";
        $this->fileformat['png'] = "png";
        $this->fileformat['jpeg'] = "jpeg";
        $this->fileformat['bmp'] = "bmp";
        $this->fileformat['gif'] = "gif";
	...
	public function getImageParams($fullpath){
        ...
        $this->format = $this->fileformat[$this->extension];
	...
	public function render($url) {
        $this->getFileParams($url);
        $this->getImageParams($url);
        ...
        switch($this->type){
            ...
            break;
            case 'image/bmp':
                imagewbmp(imagecreatefromwbmp($url));
                break;
            case 'image/gif':
                imagegif(imagecreatefromgif($url));
            break;
        }
